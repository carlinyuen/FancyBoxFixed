 ...
 * Added fix for centering on small viewports by Carlin Yuen <email.me@carlinyuen.com>
 */
	...
	var tmp, loading, overlay, wrap, outer, content, close, title, nav_left, nav_right,
		...
		_finish = function () {
			...
			if (currentOpts.type == 'iframe') {
				$('<iframe id="fancybox-frame" name="fancybox-frame' + new Date().getTime() + '" frameborder="0" hspace="0" ' + (navigator.userAgent.match(/msie [6]/i) ? 'allowtransparency="true""' : '') + ' scrolling="' + selectedOpts.scrolling + '" src="' + (videoToShow !== '' ? videoToShow : currentOpts.href) + '"></iframe>').appendTo(content);
				videoToShow = ''
			}
		...
		_get_viewport = function() {
			return [
				window.innerWidth?window.innerWidth - (currentOpts.margin * 2):$(window).width() - (currentOpts.margin * 2),
				window.innerHeight?window.innerHeight - (currentOpts.margin * 2):$(window).height() - (currentOpts.margin * 2),
